...
//
// Created:     13-Jan-2000
// RCS-ID:      $Id: stc.h 62139 2009-09-26 13:26:16Z VZ $
...
#ifndef _WX_SCINTILLACTRL_STC_H_
#define _WX_SCINTILLACTRL_STC_H_
...
#define wxSCI_MODEVENTMASKALL 0x7FFFF
...
#ifndef SWIG
//extern const char wxSTCNameStr[];
class  SDK_DLL wxScintillaCtrl;
class  SDK_DLL wxStyledTextEvent;
#endif

//----------------------------------------------------------------------

class SDK_DLL wxScintillaCtrl : public wxControl,
#if wxUSE_TEXTCTRL
...
#ifdef SWIG
    %pythonAppend wxScintillaCtrl   "self._setOORInfo(self)"
    %pythonAppend wxScintillaCtrl() ""

    wxScintillaCtrl(wxWindow *parent, wxWindowID id=wxID_ANY,
                     const wxPoint& pos = wxDefaultPosition,
                     const wxSize& size = wxDefaultSize, long style = 0,
                     const wxString& name = wxPySTCNameStr);
    %RenameCtor(PreStyledTextCtrl,  wxScintillaCtrl());

#else
    wxScintillaCtrl(wxWindow *parent, wxWindowID id=wxID_ANY,
                     const wxPoint& pos = wxDefaultPosition,
                     const wxSize& size = wxDefaultSize, long style = 0,
                     const wxString& name = "wxScintillaCtrl");
    wxScintillaCtrl() { m_swx = NULL; }
    ~wxScintillaCtrl();
...
private:
    DECLARE_EVENT_TABLE()
    DECLARE_DYNAMIC_CLASS(wxScintillaCtrl)
...
class SDK_DLL wxStyledTextEvent : public wxCommandEvent {
public:
...
#ifndef SWIG
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_CHANGE, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_STYLENEEDED, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_CHARADDED, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_SAVEPOINTREACHED, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_SAVEPOINTLEFT, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_ROMODIFYATTEMPT, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_KEY, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_DOUBLECLICK, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_UPDATEUI, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_MODIFIED, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_MACRORECORD, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_MARGINCLICK, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_NEEDSHOWN, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_PAINTED, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_USERLISTSELECTION, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_URIDROPPED, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_DWELLSTART, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_DWELLEND, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_START_DRAG, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_DRAG_OVER, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_DO_DROP, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_ZOOM, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_HOTSPOT_CLICK, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_HOTSPOT_DCLICK, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_CALLTIP_CLICK, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_AUTOCOMP_SELECTION, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_INDICATOR_CLICK, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( SDK_DLL, wxEVT_STC_INDICATOR_RELEASE, wxStyledTextEvent );
#else
    enum {
        wxEVT_STC_CHANGE,
