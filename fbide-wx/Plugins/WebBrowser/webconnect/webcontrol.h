...
class PLUGIN_DLL wxWebEvent : public wxNotifyEvent
{
public:
...
BEGIN_DECLARE_EVENT_TYPES()
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_TITLECHANGE, 0)
    //DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_CONTENTTYPE, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_OPENURI, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_LOCATIONCHANGE, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_DOMCONTENTLOADED, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_STATECHANGE, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_STATUSCHANGE, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_STATUSTEXT, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_SHOWCONTEXTMENU, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_LEFTDOWN, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_MIDDLEDOWN, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_RIGHTDOWN, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_LEFTUP, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_MIDDLEUP, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_RIGHTUP, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_LEFTDCLICK, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_DRAGDROP, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_CREATEBROWSER, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_INITDOWNLOAD, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_SHOULDHANDLECONTENT, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_FAVICONAVAILABLE, 0)
    DECLARE_EXPORTED_EVENT_TYPE(PLUGIN_DLL, wxEVT_WEB_DOMEVENT, 0)
